    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Tecido macio e encaixou certinho na cama box.',
            'Boa qualidade pelo preço, gostei bastante do acabamento.',
          ],
          pros: [
    ...
    entries: [
      ...
      },
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Função forno é ótima, versátil pra várias receitas.',
            'Capacidade boa pra família e fácil de limpar.',
          ],
          pros: [],
          cons: [],
      ...
      },
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Ótimo custo-benefício, a função forno é bem prática.',
            'Cesto antiaderente fácil de limpar e capacidade boa pra família.',
          ],
          pros: [],
          cons: [],
      ...
      },
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Cozinha rápido e uniforme, ótima potência.',
            'Fácil de limpar e o resultado fica bem crocante.',
          ],
          pros: [],
          cons: [],
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.5,
          depoimentos: [
            'Estrutura firme, ajudou muito a organizar o quarto.',
            'Fácil de montar e aproveita bem o espaço vertical.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Tapete macio e o tamanho ficou perfeito na sala.',
            'Boa qualidade e antiderrapante de verdade.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Estampa linda e o tecido é de boa qualidade.',
            'Deixou a sala muito mais aconchegante, adorei o conjunto.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Bloqueia bem a luz e o tecido é de boa qualidade.',
            'Fácil de instalar e o acabamento é bonito.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Veludo de boa qualidade, as roupas não escorregam mais.',
            'Chegou bem embalado e o tamanho é padrão pra maioria das roupas.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Material resistente, achei ótimo pra guardar roupa de cama.',
            'Boa qualidade e as caixas se encaixam bem uma na outra.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Estrutura firme e fácil de montar, organizou muitos pares.',
            'Ótimo aproveitamento de espaço vertical no closet.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Bonito e resistente, as alças facilitam pra carregar.',
            'Boa capacidade e a tampa disfarça o cheiro.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Muito potente, bate até gelo sem esforço.',
            'Copo grande e fácil de limpar depois do uso.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Antiaderente de verdade, nada gruda mesmo sem óleo.',
            'Conjunto completo e as cores deixaram a cozinha mais bonita.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Fecha bem e mantém os alimentos frescos por mais tempo.',
            'Excelente pra organizar a despensa, ficou tudo visível.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'A panela é ótima, cozinha rápido e é fácil de limpar.',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Edredom bem macio e quentinho, gostei muito.',
            'Chegou bem embalado e é do tamanho certo pra cama casal.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Toalhas macias e absorvem muito bem.',
            'Boa qualidade e as cores não desbotaram na lavagem.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Macio na medida certa, nem muito alto nem muito baixo.',
            'Bom pra quem tem alergia, não senti nenhum incômodo.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.3,
          depoimentos: [
            'Impermeável de verdade, não deixa passar nada.',
            'Fácil de colocar e não faz barulho ao deitar.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.1,
          depoimentos: [
            'Tecido bom, vestiu bem no sofá e ficou com aparência de novo.',
            'Fácil de colocar e o elástico segura bem no lugar.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Lindo, dá um toque especial na decoração da sala.',
            'Bem-feito e a folhagem é bem realista.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.3,
          depoimentos: [
            'Fácil de instalar e ficou bem firme na parede.',
            'Bonita e resistente, combina com vários estilos de decoração.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Bem grossa e quentinha, ficou linda no sofá.',
            'Tamanho gigante mesmo, cobre o sofá inteiro sem sobrar pouco.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Fácil de colar e o efeito de madeira ficou bem realista.',
            'Boa qualidade, não descolou depois de um tempo.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Iluminação bonita e dá um efeito ótimo na parede externa.',
            'Fácil de instalar e o acabamento é bem feito.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Cheiro suave e agradável, perfuma bem o ambiente.',
            'Boa duração e o pote ainda dá pra reaproveitar depois.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Fibra natural bonita, ficou lindo com as plantas.',
            'Boa qualidade e o acabamento é bem caprichado.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.5,
          depoimentos: [
            'Muito realista, ninguém percebe que é artificial de longe.',
            'Deixou o ambiente muito mais bonito e aconchegante.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.2,
          depoimentos: [
            'Bonito e confortável, ficou ótimo na sala.',
            'Fácil de montar, bem resistente e chegou rapidinho.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Fácil de montar e a luz é ótima pra leitura.',
            'Estrutura firme e o design ficou muito elegante no quarto.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Molduras de boa qualidade, ficaram ótimas na parede.',
            'Fácil de montar e o acabamento é bem caprichado.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Não fura a parede e ficou bem firme, organizou tudo.',
            'Fácil de instalar e o acabamento dourado é bonito.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Fácil de instalar e ficou muito prático pra organizar o banheiro.',
            'Material resistente e o acabamento é bem bonito.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Organizou muito bem a gaveta, encaixe perfeito.',
            'Material bom e ajudou a aproveitar melhor o espaço.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Muito bom, material resistente e organizou bem as panelas.',
            'Fácil de montar e ficou firme na bancada.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Organizou muito bem a geladeira, ótimo custo-benefício.',
            'Encaixa direitinho nas prateleiras e facilita achar tudo.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Ótimo pra organizar a mala, cada peça no seu compartimento.',
            'Material bom e ajudou muito a economizar espaço na viagem.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Muito prático, corta rápido e vem com vários acessórios.',
            'Fácil de limpar e economiza bastante tempo na cozinha.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Muito afiadas, corta com facilidade e o design é bonito.',
            'Boa qualidade e o suporte deixa a bancada organizada.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Material resistente, não risca a faca e é fácil de higienizar.',
            'Boa qualidade e tamanho ótimo pra cozinha do dia a dia.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Excelente e muito rápido, faz o suco na hora sem esforço.',
            'Fácil de limpar e o motor é potente.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Motor forte, bate massas pesadas sem esforço.',
            'Estabilidade ótima e vem com acessórios que ajudam bastante.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Grelha bem rápido e uniforme, ótimo custo-benefício.',
            'Fácil de limpar e a alça não esquenta.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Ótimo espaço, cabe bastante louça e escorre bem a água.',
            'Estrutura firme e organizou muito bem a pia.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Conjunto completo, não risca as panelas antiaderentes.',
            'Boa qualidade, o cabo de madeira é resistente.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Prático e esquenta rápido, ótimo custo-benefício.',
            'Fácil de limpar e o touch funciona bem.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Esquenta rápido e desliga sozinha, bem prática.',
            'Boa capacidade e o acabamento inox é bonito.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Mantém a temperatura por muito tempo, ótima qualidade.',
            'Prática de carregar e não vaza nada na mochila.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.5,
          depoimentos: [
            'Bem quentinha e macia, ótima pra dias frios.',
            'Boa qualidade pelo preço, as cores são bonitas.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Material grosso e de boa qualidade, não risca a mesa.',
            'Fácil de limpar e o tamanho serve bem pra mesa com 6 cadeiras.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Estampa linda, meu filho adorou o tema do jogo.',
            'Tecido macio e boa qualidade de acabamento.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Tecido macio e quentinho, muito confortável.',
            'Veio bem embalado e o tamanho ficou perfeito.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Antiderrapante de verdade e super macio.',
            'Boa qualidade e as 4 peças combinam bem no banheiro.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Material resistente e não gruda no corpo durante o banho.',
            'Boa qualidade, fácil de instalar e limpar.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Chegou tudo certinho e muito bem embalado.',
            'Maravilhoso, ficou tudo perfeito na cama.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Tecido macio e antialérgico, gostei muito da qualidade.',
            'Vem completo, economizou bastante na hora de montar o enxoval.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Ajuda muito a dormir de lado, aliviou a dor nas costas.',
            'Macio e o tecido é de boa qualidade.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Estampa linda e o tecido é macio, meu filho adorou.',
            'Bom acabamento, bem quentinho e a qualidade é boa.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Madeira de boa qualidade e ficou linda na decoração da festa.',
            'Estrutura firme, aguenta bem o peso dos doces e salgados.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.1,
          depoimentos: [
            'Ficou lindo na parede, fácil de montar as fotos.',
            'Boa qualidade pelo preço, decorou bem o ambiente.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Bonito e resistente, ficou ótimo no quarto.',
            'Fácil de montar e aproveita bem o cantinho vazio.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Números grandes e fáceis de ler, ótimo pra academia ou escritório.',
            'Fácil de configurar e dá pra ajustar bem a luminosidade.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.4,
          depoimentos: [
            'Deu um efeito muito bonito na parede, fácil de montar.',
            'Boa qualidade e valorizou bastante o ambiente.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Grande capacidade, organizou toda minha maquiagem de um jeito bonito.',
            'Material resistente e o giratório facilita muito o dia a dia.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Fácil de instalar e deixou os fios muito mais organizados.',
            'Material resistente, gostei bastante do resultado.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Produto de boa qualidade, veio direitinho.',
            'Cabides resistentes, organiza muito bem o guarda-roupa.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Prático e não deixa a escova encostar na pia.',
            'Fácil de instalar e organizou bem o banheiro.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4,
          depoimentos: [
            'Bonita e prática, cabe bastante fruta nas duas camadas.',
            'Boa qualidade pelo preço, gostei do acabamento.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Lindo na mesa, material de boa qualidade e fácil de limpar.',
            'Deu um ar sofisticado às refeições, adorei o resultado.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Base giratória facilita muito o acesso aos temperos.',
            'Boa qualidade, vidro resistente e cabe bastante tempero.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Muito potente e prático, facilita bastante no dia a dia.',
            'Fácil de limpar e as velocidades ajudam pra cada receita.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Antiaderente de verdade, desenforma fácil e sem grudar.',
            'Resistente e prático de lavar depois do uso.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Vidro de boa qualidade e o design é elegante.',
            'Chegou bem embalado, nenhuma peça quebrada.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Elegante e funcional, ficou ótimo na bancada da cozinha.',
            'Material resistente e o giro facilita puxar o papel.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Tecido macio, ajudou bastante a diminuir o frizz do cabelo.',
            'Boa qualidade e o zíper facilita trocar a fronha pra lavar.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Chegou rápido e é super macia, meu bebê adorou.',
            'Material de ótima qualidade, bem confortável para amamentar.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.8,
          depoimentos: [
            'Tecido de boa qualidade e o conjunto deixou a mesa mais bonita.',
            'Chegou bem embalado e o acabamento é caprichado.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.2,
          depoimentos: [
            'Macias e absorvem bem, ótimo custo-benefício.',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.7,
          depoimentos: [
            'Tecido de boa qualidade e caimento perfeito na cama box.',
            'Ficou com um acabamento bonito, gostei bastante.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.9,
          depoimentos: [
            'Bordado lindo, deu um toque especial na mesa.',
            'Boa qualidade de tecido e o acabamento é caprichado.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
    ...
    entries: [
      {
        ...
        product: {
          ...
          rating: 4.6,
          depoimentos: [
            'Confortável, ajudou bastante em viagem longa.',
            'Material macio e o formato apoia bem o pescoço.',
          ],
          pros: [],
          cons: [],
          lastUpdated: '2026-07-17',
